    ...
    <html lang="th" className={prompt.variable} suppressHydrationWarning={true}>
      ...
      <body className="min-h-screen bg-white text-gray-900 antialiased" style={{ fontFamily: "var(--font-prompt), sans-serif" }}>
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `if(!/^(admin|rider|stock|finance)\\./.test(location.hostname)){(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-NL5D6NR7');}`,
          }}
        />
        <script
